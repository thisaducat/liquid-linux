...
login() {
    ...
    echo "proot-distro login --user $user liquid --bind /dev/null:/proc/sys/kernel/cap_last_last --fix-low-ports --no-sysvipc --isolated" >> /data/data/com.termux/files/usr/bin/liquid
